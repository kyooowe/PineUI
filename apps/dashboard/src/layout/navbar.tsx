...
const Navbar = memo(() => {
    ...
    const zustandStoreAccount = useAccountStore(
        (state) => state.storeAccount
    )
    //#endregion
    ...
    return (
        <header className="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:pl-72 dark:bg-gray-800 dark:border-gray-700">
            <nav className="flex basis-full items-center w-full mx-auto px-4 sm:px-6 md:px-8" aria-label="Global">
                <div className="mr-5 lg:mr-0 lg:hidden">
                    <a className="flex-none text-xl font-semibold text-blue-800 dark:text-blue-500" href="#" aria-label="Brand">PineUI</a>
                </div>
                ...
                <div className="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
                    ...
                    <div>
                        ...
                        <div className='block md:hidden sm:hidden'>
                            <label className='text-transparent'>Transparent</label>
                        </div>
                    </div>
                        ...
                        <div className="hs-dropdown relative inline-flex [--placement:bottom-right]">
                            ...
                            <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700" aria-labelledby="hs-dropdown-with-header">
                                <div className="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg dark:bg-gray-700">
                                    ...
                                    <p className="text-sm font-medium text-gray-800 dark:text-gray-300">johndoe@demo.com</p>
                                </div>
                                <div className="mt-2 py-2 first:pt-0 last:pb-0">
                                    <a className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="#">
